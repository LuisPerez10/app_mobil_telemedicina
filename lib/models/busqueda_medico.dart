...
ListaMedicos listaMedicosFromJson(String str) => ListaMedicos.fromJson(json.decode(str));
...
class ListaMedicos {
    ...
    factory ListaMedicos.fromJson(Map<String, dynamic> json) => ListaMedicos(
        ok: json["ok"],
        listamedicos: List<MedicoResponse>.from(json["listamedicos"].map((x) => medicoResponseFromJson(x))),
    );
